<?php $__env->startSection('title', 'Kupon - SALZA'); ?>
<?php $__env->startSection('page-title', 'Data Kupon'); ?>
...
var API = {
    list:   '<?php echo e(route("admin.kupon.list")); ?>',
    store:  '<?php echo e(route("admin.kupon.store")); ?>',
    show:   function(id){ return '<?php echo e(route("admin.kupon.show", "ID")); ?>'.replace('ID', id); },
    update: function(id){ return '<?php echo e(route("admin.kupon.update", "ID")); ?>'.replace('ID', id); },
    delete: function(id){ return '<?php echo e(route("admin.kupon.destroy", "ID")); ?>'.replace('ID', id); }
};
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/irawan/laravel/shoesmarket/UMKMmm/UMKM/resources/views/admin/kupon/index.blade.php ENDPATH**/ ?>