...
<script>
// Hitung badge di header
document.addEventListener('DOMContentLoaded', () => {
    const rows = document.querySelectorAll('#stok-table tbody tr');
    let emptyCount = 0, lowCount = 0;
    rows.forEach(row => {
        const badges = row.querySelectorAll('td:nth-child(5) span');
        badges.forEach(b => {
            if (b.textContent.trim() === 'Habis') emptyCount++;
            if (b.textContent.trim() === 'Menipis') lowCount++;
        });
    });
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/irawan/laravel/shoesmarket/UMKMmm/UMKM/resources/views/admin/stok.blade.php ENDPATH**/ ?>