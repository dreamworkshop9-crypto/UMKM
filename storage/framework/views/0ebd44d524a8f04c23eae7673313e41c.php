...
<!-- Dashboard -->
<a class="flex items-center gap-3 bg-active-gradient text-white px-4 py-2.5 rounded-lg shadow-lg shadow-indigo-500/20 mb-4" href="<?php echo e(route('admin.dashboard')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.brands.index')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.kategori')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.produk')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.slider')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.kupon')); ?>">
...
<a class="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.masuk')); ?>">
<span class="material-symbols-outlined text-[14px] text-indigo-400/50">more_horiz</span><span>Pesanan Masuk</span>
</a>
<a class="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.dikonfirmasi')); ?>">
<span class="material-symbols-outlined text-[14px] text-indigo-400/50">more_horiz</span><span>Pesanan Di Konfirmasi</span>
</a>
<a class="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.dikemas')); ?>">
<span class="material-symbols-outlined text-[14px] text-indigo-400/50">more_horiz</span><span>Pesanan Di Kemas</span>
</a>
<a class="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.dikirim')); ?>">
<span class="material-symbols-outlined text-[14px] text-indigo-400/50">more_horiz</span><span>Pesanan Dikirim</span>
</a>
<a class="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.diperjalanan')); ?>">
<span class="material-symbols-outlined text-[14px] text-indigo-400/50">more_horiz</span><span>Pesanan Dalam Perjalanan</span>
</a>
<a class="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.selesai')); ?>">
<span class="material-symbols-outlined text-[14px] text-indigo-400/50">more_horiz</span><span>Pesanan Selesai</span>
</a>
</div>

<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.pembatalan')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.pengembalian')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.ulasan')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.stok')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.users')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.admins')); ?>">
...
<a class="flex items-center justify-between text-slate-400 hover:text-white px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.laporan')); ?>">
...
<img alt="Profile" class="w-8 h-8 rounded-full border border-indigo-500/30 object-cover" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name ?? 'Admin')); ?>&background=6366f1&color=fff"/>
</div>
...
</html><?php /**PATH /home/irawan/laravel/shoesmarket/UMKMmm/UMKM/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>