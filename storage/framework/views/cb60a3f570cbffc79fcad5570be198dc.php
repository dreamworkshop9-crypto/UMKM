...
const r=await fetch(API.update(id),{method:'POST',headers:{'Accept':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},body:fd});if(!r.ok){const err=await r.json();throw new Error(err.message||err.errors?Object.values(err.errors)[0][0]:'Gagal')}const d=await r.json();closeEdit();showToast(d.message);await fetchData()}catch(err){showToast(err.message||'Gagal memperbarui','error')}});
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\UMKM-main\resources\views/admin/produk/index.blade.php ENDPATH**/ ?>