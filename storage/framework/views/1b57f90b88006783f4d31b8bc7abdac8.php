...
<div class="bg-[#1c1c2d] rounded-xl border border-outline-variant/20 overflow-hidden">  
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-[12px] text-slate-500 mt-1"><?php echo e($labelPeriode); ?></p>
        </div>
    </div>
    ...
    <div class="flex flex-wrap items-end gap-3 mb-6">
        <div>
            ...
            <select class="filter-select" id="filterPeriode" onchange="toggleCustom()">
                ...
                <option value="custom" <?php echo e($periode === 'custom' ? 'selected' : ''); ?>>Custom</option>
            </select>
        </div>
        <div id="customRange" class="<?php echo e($periode === 'custom' ? 'show' : ''); ?> items-end gap-3">
            <div>
                <label class="block text-[11px] text-slate-500 font-medium mb-1.5 uppercase tracking-wider">Dari</label>
                <input type="date" class="filter-input" id="filterDari" value="<?php echo e($dari ?? ''); ?>"/>
            </div>
            <div>
                <label class="block text-[11px] text-slate-500 font-medium mb-1.5 uppercase tracking-wider">Sampai</label>
                <input type="date" class="filter-input" id="filterSampai" value="<?php echo e($sampai ?? ''); ?>"/>
            </div>
        </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="card-stat">
            ...
            <p class="text-2xl font-bold text-emerald-400 mt-2">Rp <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?></p>
        </div>
        <div class="card-stat">
            <p class="text-[11px] text-slate-500 font-medium uppercase tracking-wider">Total Pesanan</p>
            <p class="text-2xl font-bold text-white mt-2"><?php echo e(number_format($totalPesanan)); ?></p>
        </div>
        <div class="card-stat">
            <p class="text-[11px] text-slate-500 font-medium uppercase tracking-wider">Pesanan Selesai</p>
            <p class="text-2xl font-bold text-indigo-400 mt-2"><?php echo e(number_format($pesananSelesai)); ?></p>
        </div>
        <div class="card-stat">
            <p class="text-[11px] text-slate-500 font-medium uppercase tracking-wider">Pesanan Dibatalkan</p>
            <p class="text-2xl font-bold text-red-400 mt-2"><?php echo e(number_format($pesananDibatalkan)); ?></p>
        </div>
    </div>
        ...
        <div class="tbl-wrapper">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-slate-500"><?php echo e($i + 1); ?></td>
                        <td class="font-medium text-white"><?php echo e($p['name']); ?></td>
                        <td class="text-right"><?php echo e($p['qty']); ?></td>
                        <td class="text-right text-emerald-400">Rp <?php echo e(number_format($p['revenue'], 0, ',', '.')); ?></td>
                    </tr>
        ...
        <div class="tbl-wrapper">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <span class="badge-status-laporan bs-<?php echo e($ps->status); ?>">
                                <?php echo e(ucfirst(str_replace('_', ' ', $ps->status))); ?>

                            </span>
                        </td>
                        <td class="text-right font-medium text-white"><?php echo e($ps->total); ?></td>
                        <td class="text-right text-slate-400"><?php echo e($totalPesanan > 0 ? round(($ps->total / $totalPesanan) * 100, 1) : 0); ?>%</td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="px-5 py-3 border-t border-outline-variant/20">
                <div class="flex items-center gap-2 h-3 rounded-full overflow-hidden bg-[#121220]">
                    ...
                    ?>
                    <div style="width:<?php echo e($pct); ?>%;background:<?php echo e($color); ?>;min-width:4px;" title="<?php echo e(ucfirst($ps->status)); ?>: <?php echo e(round($pct,1)); ?>%"></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/irawan/laravel/shoesmarket/UMKMmm/UMKM/resources/views/admin/laporan.blade.php ENDPATH**/ ?>