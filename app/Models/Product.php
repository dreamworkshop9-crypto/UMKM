...
class Product extends Model {
    ...
    protected $fillable = ['name','slug','description','price','old_price','stock','stok','harga','thumbnail','sku','weight','kategori_id','subcategory_id','subsubcategory_id','brand_id','is_active','is_new','is_best_seller'];
    ...
    public function getThumbnailUrlAttribute() {
        ...
        return $path ? asset('storage/'.$path) : 'https://via.placeholder.com/300x300?text=No+Image';
    }
