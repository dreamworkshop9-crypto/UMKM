    ...
    <footer class="border-t border-slate-700/20 pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                ...
                <div><h4 class="text-sm font-semibold text-white uppercase tracking-wider mb-4">Kategori</h4><ul class="space-y-3">@foreach($kategori ?? [] as $kat)<li><a href="#" onclick="setCategory('{{$kat->id}}');document.getElementById('produk').scrollIntoView({behavior:'smooth'});return false;" ...> class="text-sm text-slate-500 hover:text-brand-400">{{ $kat->name }}</a></li>@endforeach</ul></div>
