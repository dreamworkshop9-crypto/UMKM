...
@section('title', 'Dashboard - SALZA')

@section('content')
<!-- BEGIN: StatsGrid -->
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <!-- Card 1: Penjualan Bulan Ini -->
    <div class="bg-dashboard-card p-6 rounded-xl border border-slate-700/30 flex flex-col justify-between h-40">
        ...
        <div class="flex justify-between items-start">
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-2 text-xs text-rose-500 flex items-center">
            ...
            <div class="bg-rose-500/10 p-3 rounded-lg">
                <svg class="w-6 h-6 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path d="M16 8l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2M5 3a2 2 0 00-2 2v1c0 8.284 6.716 15 15 15h1a2 2 0 002-2v-3.279a1 1 0 00-.684-.948l-4.493-1.498a1 1 0 00-1.209.388l-2.235 2.235a13.177 13.177 0 01-5.474-5.474l2.235-2.235a1 1 0 00.388-1.209L9.107 4.316a1 1 0 00-.948-.684H5z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
                </svg>
            </div>
        </div>
    </div>
...
<div class="bg-dashboard-card rounded-xl border border-slate-700/30 overflow-hidden">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse" id="new-orders-table">
            <thead>
            ...
            <tbody class="divide-y divide-slate-700/50">
                <!-- Table is currently empty as per image, but structured for data -->
                <tr data-purpose="empty-row">
