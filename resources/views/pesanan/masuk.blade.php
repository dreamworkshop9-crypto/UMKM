    ...
    <div class="bg-dashboard-card rounded-2xl border border-slate-700/30 overflow-hidden mb-6">
        <div class="p-6 border-b border-slate-700/50">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-white">Pesanan Masuk</h2>
                    <p class="text-xs text-slate-500 mt-0.5">Pesanan baru menunggu konfirmasi admin</p>
                </div>
            </div>
        </div>
        <!-- Info pesanan -->
        <div class="p-6 border-b border-slate-700/50 flex items-center gap-4">
            <div class="w-full grid grid-cols-3 gap-4">
                <div class="bg-slate-800 rounded-xl border border-slate-700/50 p-4">
                    ...
                    <p class="text-xl font-bold text-white coupon-code" id="pesananCode">-</p>
                </div>
                <div class="bg-slate-800 rounded-xl border border-slate-700/50 p-4">
                    <p class="text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Pelanggan</p>
                    <p class="text-sm text-white font-medium" id="pesananCustomer">-</p>
                </div>
                <div class="bg-slate-800 rounded-xl border border-slate-700/50 p-4">
                    <p class="text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Total Pesanan</p>
                    <p class="text-xl font-bold text-white" id="pesananTotal">Rp0</p>
                </div>
            </div>
        </div>

        <!-- Tabel pesanan items -->
        <div class="bg-dashboard-card rounded-2xl border border-slate-700/30 overflow-hidden">
            <div class="px-6 border-b border-slate-700/50 flex items-center justify-between">
                ...
                <span class="text-xs text-slate-500">Pesanan #<span class="text-white font-semibold" id="pesananId">-</span></span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody id="pesananItems" class="divide-y divide-slate-700/50">
                        <tr><td colspan="5" class="px-6 py-10 text-center text-slate-500 italic">Belum ada item pesanan.</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <!-- Tombol konfirmasi -->
        <div class="mt-6 bg-dashboard-card rounded-2xl border border-slate-700/30 overflow-hidden">
            ...
            <form id="confirmForm" class="p-6">
                <div class="bg-slate-800 rounded-xl border border-slate-700/50 p-5 mb-5">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Pesanan #<span class="text-white font-bold" id="confirmId">-</span></p>
                        </div>
                    </div>
                </div>
                <div class="bg-slate-800 rounded-xl border border-slate-700/50 p-5 mb-5">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-white" id="confirmCustomer">-</p>
                ...
                <div class="bg-slate-800 rounded-xl border border-slate-700/50 p-5 mb-5">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-10 h-10 rounded-lg bg-slate-700 flex items-center justify-center">
                            <i class="fa-solid fa-truck text-slate-400 text-lg"></i>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-white" id="confirmItems">-</p>
                            <p class="text-xs text-slate-500">Jumlah item</p>
                        </div>
                    </div>
                </div>
