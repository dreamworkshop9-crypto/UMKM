...
@section('title', 'Dibatalkan - SALZA')
@section('page-title', 'Dibatalkan')

@section('styles')
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
<style>
.row-hover{transition:background .15s,box-shadow .15s}
.row-hover:hover{background:rgba(220,38,38,.06);box-shadow:inset 3px 0 0 #dc2626}
...
<div class="max-w-5xl mx-auto">
    <!-- Status badge merah -->
    <div class="bg-dashboard-card rounded-2xl border border-red-500/30 overflow-hidden mb-6">
        <div class="border-b border-slate-700/50 px-6 py-4 flex items-center gap-3">
            ...
            <div>
                <h2 class="text-lg font-semibold text-white">Dibatalkan</h2>
                <p class="text-xs text-slate-500 mt-0.5">Pesanan telah dibatalkan</p>
            </div>
        </div>
    </div>
    ...
    <!-- Tombol -->
    <div class="bg-dashboard-card rounded-2xl border border-red-500/30 overflow-hidden">
        <div class="p-6">
            <div class="border border-red-500/20 bg-red-500/5 rounded-xl border-dashed border-l-4 pl-5 py-3 mb-5">
                <div class="flex items-center gap-2 mb-1">
                    <i class="fa-solid fa-circle-xmark text-red-500 text-sm"></i>
                    <p class="p-0 text-sm font-semibold text-red-200">Pesanan telah dibatalkan.</p>
                </div>
            </div>
            <div class="flex gap-3">
                ...
                <button type="button" id="viewBtn" class="flex-1 py-2.5 bg-red-600 hover:bg-red-700 text-white text-sm font-bold rounded-lg shadow-md shadow-red-500/20 hover:shadow-lg hover:shadow-red-500/30 transition-all flex items-center justify-center gap-2">
                    <i class="fa-solid fa-circle-xmark text-xs"></i>Lihat Detail
                </button>
            </div>
        </div>
    </div>
