...
var API = {
    ...
    show:   function(id){ return '{{ route("admin.slider.show", "ID") }}'.replace('ID', id); },
    update: function(id){ return '{{ route("admin.slider.update", "ID") }}'.replace('ID', id); },
    delete: function(id){ return '{{ route("admin.slider.destroy", "ID") }}'.replace('ID', id); }
};
