...
<div class="bg-[#1c1c2d] rounded-xl border border-outline-variant/20 overflow-hidden">
    ...
    <div class="px-6 py-5 border-b border-outline-variant/10 flex items-center justify-between">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-orange-500/15 rounded-lg flex items-center justify-center">
                <span class="material-symbols-outlined text-orange-400 text-[20px]">assignment_return</span>
            </div>
            <div>
                <h2 class="text-[16px] font-semibold text-white">Pengembalian</h2>
                <p class="text-[12px] text-slate-500">Pesanan selesai yang diajukan pengembalian oleh pelanggan</p>
            </div>
        </div>
        <span class="bg-orange-500 text-white text-[11px] font-bold px-2 py-0.5 rounded-full min-w-[24px] h-[24px] flex items-center justify-center">{{ $pesanan->total() }}</span>
    </div>
    ...
    <!-- Info Banner -->
    <div class="mx-6 mt-4 mb-2 px-5 py-3 rounded-xl bg-orange-500/10 border border-orange-500/20 flex items-center gap-3">
        <span class="material-symbols-outlined text-orange-400 text-[20px]">info</span>
        <p class="text-[12px] text-orange-300">Pesanan dengan status <span class="font-bold">Selesai</span> yang muncul di sini adalah kandidat pengembalian. Fitur aksi pengembalian akan tersedia setelah tabel pengembalian dibuat.</p>
    </div>
            ...
            <tbody>
                @if($pesanan->count() > 0)
                    ...
                    <tr class="border-b border-outline-variant/5 hover:bg-[#1a1a2e] transition-colors">
                        ...
                        <td class="px-6 py-4 text-[13px] text-orange-400 font-mono font-medium">{{ $item->code }}</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <span class="text-[11px] font-bold px-2.5 py-1 rounded-full border bg-emerald-500/15 text-emerald-400 border-emerald-500/20">Selesai</span>
                        </td>
                        <td class="px-6 py-4">
                    ...
                    <tr>
                        <td class="px-6 py-16 text-center" colspan="7">
                            <div class="flex flex-col items-center gap-2 py-8">
                                <span class="material-symbols-outlined text-[48px] text-orange-500/10">assignment_return</span>
                                <p class="text-slate-500 text-[14px]">Belum ada pesanan yang diajukan pengembalian</p>
                                <p class="text-slate-600 text-[12px]">Pesanan selesai akan muncul di sini</p>
                            </div>
                        </td>
                    </tr>
                @endif
