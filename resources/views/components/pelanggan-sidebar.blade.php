<aside class="w-64 bg-dashboard-card flex-shrink-0 flex flex-col border-r border-slate-700/50 fixed h-full z-30">
    ...
    <nav class="flex-1 overflow-y-auto px-4 py-2 text-sm">
        <!-- Dashboard -->
        <div class="mb-6">
            <a class="flex items-center px-4 py-3 rounded-lg transition-all @if(Route::currentRouteName() === 'pelanggan.dashboard') text-white shadow-lg shadow-emerald-500/20 bg-slate-700/50 @else text-slate-400 hover:bg-slate-700/50 hover:text-white @endif" href="{{ route('pelanggan.dashboard') }}">
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1">
                <li>
                    <a class="flex items-center justify-between px-4 py-2 rounded-lg transition-colors @if(Route::currentRouteName() === 'pelanggan.pesanan') bg-slate-700/50 text-white @else text-slate-400 hover:bg-slate-700/50 hover:text-white @endif" href="{{ route('pelanggan.pesanan') }}">
                ...
                <li>
                    <a class="flex items-center justify-between px-4 py-2 rounded-lg transition-colors @if(Route::currentRouteName() === 'pelanggan.ulasan') bg-slate-700/50 text-white @else text-slate-400 hover:bg-slate-700/50 hover:text-white @endif" href="{{ route('pelanggan.ulasan') }}">
                        <span class="flex items-center">
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1">
                <li>
                    <a class="flex items-center justify-between px-4 py-2 rounded-lg transition-colors @if(Route::currentRouteName() === 'pelanggan.profil') bg-slate-700/50 text-white @else text-slate-400 hover:bg-slate-700/50 hover:text-white @endif" href="{{ route('pelanggan.profil') }}">
                        <span class="flex items-center">
                ...
                <li>
                    <a class="flex items-center justify-between px-4 py-2 rounded-lg transition-colors @if(Route::currentRouteName() === 'pelanggan.alamat') bg-slate-700/50 text-white @else text-slate-400 hover:bg-slate-700/50 hover:text-white @endif" href="{{ route('pelanggan.alamat') }}">
                        <span class="flex items-center">
